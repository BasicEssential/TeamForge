...
"GRP_SELECT": "SELECT {GRP_COLS_V}, {AGGR_COLS} FROM {TABLE} WHERE 1=1 {CONDS} GROUP BY {GRP_COLS}",
"GRP_HAV_SELECT": "SELECT {GRP_COLS_V}, {AGGR_COLS} FROM {TABLE} WHERE 1=1 {CONDS} GROUP BY {GRP_COLS} HAVING {HCOND}",
